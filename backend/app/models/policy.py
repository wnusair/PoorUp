...
LOBBYING_AXES = {
    ...
    "capital_markets": {
        ...
        "description": "Make outside money easier or harder. Looser rules boost growth; tighter rules calm the board.",
        "order": 35,
        "government_types": ["liberal_democracy"],
        "directions": {
            "expand": {"label": "Expand", "target": "market_deregulation"},
            "tighten": {"label": "Tighten", "target": "capital_controls"},
        },
    },
    "cash_bonus": {
        "axis": "cash_bonus",
        "label": "Cash Bonus",
        "description": "Raise or cut the round-end cash bonus paid on spare cash.",
        "order": 36,
        "government_types": ["liberal_democracy"],
        "directions": {
            "increase": {"label": "Increase", "target": "cash_bonus_increase"},
            "decrease": {"label": "Decrease", "target": "cash_bonus_decrease"},
        },
    },
    "investor_mood": {
        "axis": "investor_mood",
        "label": "Investor Mood",
        "description": "Directly boost or cool the market's confidence.",
        "order": 37,
        "government_types": ["liberal_democracy"],
        "directions": {
            "boost": {"label": "Boost", "target": "investor_mood_increase"},
            "cool": {"label": "Cool", "target": "investor_mood_decrease"},
        },
    },
    "housing_regulation": {
...
DEFAULT_LOBBYING_POLICIES = {
    ...
    "market_deregulation": {
        ...
        "axis": "capital_markets",
        "axis_label": "Investor Rules",
        "direction": "expand",
        "direction_label": "Expand",
        "effect_value": 8.0,
        "cost_hint": 280,
        "description": "Make outside-money deals easier and stronger, but raise social heat.",
        "government_types": ["liberal_democracy"],
        "government_effect_multipliers": {"liberal_democracy": 1.15},
    },
    "capital_controls": {
        "policy_name": "Tighten Investor Rules",
        "target_stat": "capital_controls",
        "axis": "capital_markets",
        "axis_label": "Investor Rules",
        "direction": "tighten",
        "direction_label": "Tighten",
        "effect_value": 8.0,
        "cost_hint": 260,
        "description": "Make outside-money deals weaker and calm the board down.",
        "government_types": ["liberal_democracy"],
    },
    "cash_bonus_increase": {
        ...
        "effect_value": 0.0035,
        "cost_hint": 250,
        "description": "Raise the round-end cash bonus paid on spare cash.",
        "government_types": ["liberal_democracy"],
    },
    "cash_bonus_decrease": {
        "policy_name": "Decrease Cash Bonus",
        "target_stat": "cash_bonus_decrease",
        "axis": "cash_bonus",
        "axis_label": "Cash Bonus",
        "direction": "decrease",
        "direction_label": "Decrease",
        "effect_value": 0.0035,
        "cost_hint": 230,
        "description": "Cut the round-end cash bonus and cool down passive-cash play.",
        "government_types": ["liberal_democracy"],
    },
    "investor_mood_increase": {
        "policy_name": "Boost Investor Mood",
        "target_stat": "investor_mood_increase",
        "axis": "investor_mood",
        "axis_label": "Investor Mood",
        "direction": "boost",
        "direction_label": "Boost",
        "effect_value": 4.5,
        "cost_hint": 240,
        "description": "Raise market confidence directly to strengthen liberal-democracy market perks.",
        "government_types": ["liberal_democracy"],
    },
    "investor_mood_decrease": {
        "policy_name": "Cool Investor Mood",
        "target_stat": "investor_mood_decrease",
        "axis": "investor_mood",
        "axis_label": "Investor Mood",
        "direction": "cool",
        ...
        "effect_value": 4.5,
        "cost_hint": 220,
        "description": "Cool market confidence directly and make the board calmer.",
        "government_types": ["liberal_democracy"],
    },
}
