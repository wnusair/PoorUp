...
export const lobbyUpdateColor = (roomCode, colorHex) =>
  api.patch(`/lobby/${roomCode}/color`, { color_hex: colorHex });
export const lobbySetReady = (roomCode, ready) =>
  api.patch(`/lobby/${roomCode}/ready`, { ready });
...
// Admin
export const adminSeedPlotDebug = (matchId) => api.post(`/admin/${matchId}/plot/debug-seed`);
