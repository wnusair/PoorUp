...
export default function TradePanel({ myPlayerId, onSubmit, onRespond, onClose }) {
  ...
  const policyOptions = useMemo(() => {
    ...
    return [
      { target: 'tax_multiplier_decrease', label: 'Tax Relief' },
      { target: 'welfare_increase', label: 'Welfare Increase' },
      { target: 'welfare_decrease', label: 'Welfare Cuts' },
      { target: 'tax_multiplier_increase', label: 'Tax Hike' },
      { target: 'stabilization_fund', label: 'Stabilization Fund' },
      { target: 'economic_stimulus', label: 'Economic Stimulus' },
    ];
  }, [lobbyingStats]);
