                ...
                <div className="rounded-lg border border-rose-900/60 bg-rose-950/30 p-3 text-sm text-rose-100">
                  ...
                  <p className="mt-1 text-xs text-rose-100/80">
                    <span className="inline-flex items-center gap-1">
                      ...
                      <HelpTooltip content="How close this single property is to a protest, strike, uprising, or takeover." label="Local pressure help" />
                    </span>
                    {' '}{Math.round(Number(property.social_tension || 0))}
                    {' '}•{' '}
                    <span className="inline-flex items-center gap-1">
                      <span>Area pressure</span>
                      <HelpTooltip content="How unstable the wider owner-and-region area is. High area pressure makes nearby trouble more likely to spread." label="Area pressure help" />
                    </span>
                  ...
                  {property.social_dominant_grievance && (
                    <p className="mt-1 text-xs text-rose-100/70">
                      <span className="inline-flex items-center gap-1">
                        ...
                        <HelpTooltip content="This is the main reason the area is getting angrier right now." label="Main cause help" />
                      </span>
                  ...
                  <div className="rounded-lg border border-cyan-900/60 bg-cyan-950/20 p-3 text-xs text-cyan-100">
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTooltip
                        ...
                        content={`Investor Mood is the market's confidence level. Cash Bonus pays on money you keep above ${formatMoney(capitalYieldReserveFloor)}. Build Loan Bonus raises how much a build loan can pay back.${activePlayerCount === 2 ? ` A 1v1 bonus is also active, adding another ${headsUpBuildLoanBonusPercent.toFixed(0)}%.` : ''}`}
                      />
                    </div>
